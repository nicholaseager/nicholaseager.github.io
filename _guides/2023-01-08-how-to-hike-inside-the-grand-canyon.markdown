...
### Table of Contents
1. [Suggested Routes](#suggested-routes)
2. [Preparation](#preparation)
3. [Map and Itinerary](#map-and-itinerary)
5. [After the Hike](#celebrate-your-accomplishment)
6. [Spending the Night at the Bottom](#spending-the-night-at-the-bottom)
7. [More Help](#need-more-help)

### Suggested Routes

{% include youtube.html id="Rp4V6waPRZo" %}

When I did this hike, we started from Bright Angel Trailhead, hiked down to Plateau Point, further down to Phantom Ranch, and then back up to South Kaibab Trailhead. We completed the entire route (over 26 miles) in one day. This is extremely physically demanding, so you need a good understanding of your physical ability before attempting (check out my video above 🙂) However, you do have the option to spend the night at the bottom of the canyon (more info below).
...
| Phase                                                  | (Dist / Elev)          |
|--------------------------------------------------------|-----------------------:|
| Spend the night on the Rim                             | -                      |
| Bright Angle Trailhead to Plateau Point                | (11km / -968m)         |
| Plateau Point to Phantom Ranch                         | (12km / -380m)         |
| Spend the Night at the Bottom (Optional)               | -                      |
| Phantom Ranch to South Kaibab Trailhead                | (17km / +1413m)        |
| Spend the night on the Rim                             | -                      |

#### Spend the night on the Rim

You'll want to start this hike early, to avoid possible crowds and also to give yourself extra time if you're doing this hike in one day. We stayed at Mather Campground, which I can recommend because it is cheap and easy to access the rim. Each campsite has a picnic table, fire ring, and bear box. The campground has flush toilets, as well as a few coin-operated showers. There are water spigots located within the campground.
...
If you want to spend the night at the bottom of the Grand Canyon, you have three main options:
...
Please <a href="{{ "/contact" | relative_url }}">contact</a> me if you want to ask questions; I am happy to help.

You can also check out [a video](https://www.youtube.com/watch?v=Rp4V6waPRZo) that I made about our entire trip! I tried my best to capture all of the little beautiful moments by letting them speak for themselves. So there are no explanations or speaking in this video, just moments :)